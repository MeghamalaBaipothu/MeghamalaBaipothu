...
**Technologies:** Power BI · Power Query · DAX · Data Visualization · Business Intelligence
...
**Technologies:** MySQL · SQL · Data Analysis · Database Concepts
...
**Technologies:** Python · Pandas · BeautifulSoup · Requests · Matplotlib · Seaborn

---

### 💰 Personal Expense Tracker

Python and Streamlit web application for managing **income, expenses, transactions, and financial summaries**.

🔗 [View Project](https://github.com/MeghamalaBaipothu/personal-expense-tracker)
